...
#
#     As an extension, you can in Python handle StringIO and BytesIO
#     from the io package to manage the input as a *stream*, without
#     holding the entire string in memory.
