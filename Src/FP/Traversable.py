...
from .functions   import identity, EffectfulFunction, get_effect
...
def traverse( g: Callable, t: Traversable, effect: Optional[type[Applicative]] = IdentityA) -> Applicative:
...
def sequence(t: Traversable, effect: Optional[type[Applicative]] = IdentityA) -> Applicative:
...
def itraverse( g: Callable, t: IndexedTraversable, effect: Optional[type[Applicative]] = IdentityA) -> Applicative:
