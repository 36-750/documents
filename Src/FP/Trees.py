...
from .Functor     import Functor, IndexedFunctor, map, imap
from .Applicative import Applicative, map2, ap
from .Traversable import Traversable, traverse, itraverse
from .List        import List
from .functions   import partial2
...
class BinaryTree[A](AbstractBinaryTree):
    ...
    def _bt_traverse(effect, node_f, subtree_f, t):
        ...
        return self._bt_traverse(g, inorder, self, effect)
...
def binary_tree(spec=None, left=Tip, right=Tip, seed=None, **kwds):
