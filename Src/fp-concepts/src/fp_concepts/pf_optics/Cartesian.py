...
__all__ = ['Cartesian', 'into_first', 'into_second']
...
def lens[A, B, S, T](
    ...
    def the_lens(p_ab: Cartesian[A, B]) -> Cartesian[S, T]:
        p_ac_bc = p_ab.into_first()
        return p_ac_bc.dimap(lambda s: (getter(s), s),
